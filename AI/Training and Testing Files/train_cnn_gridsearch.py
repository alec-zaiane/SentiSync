...
for lr, batch_size, num_epochs, weight_decay in product(hyperparameters['lr'], hyperparameters['batch_size'], hyperparameters['num_epochs'], hyperparameters['weight_decay']):
